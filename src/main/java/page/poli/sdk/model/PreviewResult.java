 ...
 *
 * <p>Note: {@code render().preview} uses {@code totalPages}, while
 * {@code client.documents().preview(...)} (Phase 6) uses {@code pageCount} — that mismatch is on
 * the deployed API, not the SDK.
 *
