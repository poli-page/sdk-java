...
/**
 * The requested resource existed once but is permanently unavailable. HTTP {@code 410}. Typically
 * a soft-deleted document ({@code GONE}) or an organization that was purged
