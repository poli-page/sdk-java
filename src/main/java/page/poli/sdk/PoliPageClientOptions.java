 ...
 * {@link PoliPageClient.Builder#build()} and stored on the client for the lifetime of the
 * instance.
 *
 * <p>Package-private on purpose — consumers reach the option values through the client's facade
 * methods, never directly. Tests in the same package access this for default-validation
 * assertions.
 */
